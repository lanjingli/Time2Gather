...
fun PreferencesNavBarScreen(
    ...
    if (openDialog){
        AlertDialog(
            ...
            text = {Text(stringResource(id = R.string.saved), textAlign = TextAlign.Center)}
        )
    }
    Column(
        modifier = modifier,
...
@Composable
fun PreferencesNavBarPreview(){
    PreferencesNavBarScreen(modifier = Modifier
        .fillMaxSize()
        .padding(16.dp),
